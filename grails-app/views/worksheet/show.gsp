		...
		<div id="show-worksheet" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:worksheetInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit btn btn-lg btn-primary btn-block" action="edit" resource="${worksheetInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
