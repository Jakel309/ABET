...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ABET.Person'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ABET.PersonRole'
grails.plugin.springsecurity.authority.className = 'com.ABET.Role'
